...
给想长期维护研究主线的人用的自托管论文情报系统。

它不是那种“每天抓一堆论文、推一堆摘要”的工具。  
`Research Intel` 更像一个研究工作台：围绕你的研究画像，每天只留下少量真正贴主线的论文，并把每篇沉淀成一个可以反复回看、继续扩写、长期保留的 HTML 档案。
